 ...
 *
 * Los DTOs son clases que se utilizan para encapsular datos y transferirlos entre las
 ...
 *
 * Los objetos de respuesta (Response) se utilizan para representar las respuestas de la
 ...
 *
 * En este paquete, se definen tanto los DTOs como los Responses necesarios para transmitir
